...
const uint32 AdjustmentScreenVUEngineIconTiles[33] __attribute__((aligned(4))) =
{
    0x00000000,
...
const uint16 AdjustmentScreenVUEngineIconMap[9] __attribute__((aligned(4))) =
{
